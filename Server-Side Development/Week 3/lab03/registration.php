   ...
   createConnection();
    ...
    if(array_key_exists('hidIsReturning',$_POST)) {
        ...
        case 'delete':
            ...
            //displayMessage("DEBUG DELETE button pushed.", "red");
            ...
            // Clear out the current selected runner from txt fields
            clearThisRunner();
          break;
        // = = = = = = = = = = = = = = = = = = = 
        // ADD NEW RUNNER 
        ...
        case 'new':
          ...
          //displayMessage("DEBUG ADD button pushed.", "green");
          ...
          // Check for duplicate names using fName, lName, and phoneNumber
            ...
            //WHERE fName='John'
            //AND   lName='Watson'
            //AND   phone='5071237899'";
            //$result = $conn->query($sql);
            //$row=$result->fetch_assoc();
            //displayMessage("Count: " . $row['total'], "green");
            ...
            //No duplicates
                ...
                // Test SELECT for compound INSERT
        ...
        // = = = = = = = = = = = = = = = = = = = 
        case 'update':
          //displayMessage("DEBUG UPDATE button pushed.", "blue");
